...
type Service struct {
	...
	RawId int64 `protobuf:"varint,21,opt,name=raw_id,json=rawId,proto3" json:"raw_id,omitempty"`
...
const file_moego_business_setting_v1_service_proto_rawDesc = "" +
	"\n" +
	"'moego/business/setting/v1/service.proto\x12\x19moego.business.setting.v1\x1a\x17google/type/money.proto\"\xc7\t\n" +
	"\aService\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x15\n" +
	"\x06raw_id\x18\x15 \x01(\x03R\x05rawId\x12\x12\n" +
