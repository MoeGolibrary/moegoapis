...
var file_moego_business_customer_v1_pet_proto_goTypes = []interface{}{
...
func file_moego_business_customer_v1_pet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_moego_business_customer_v1_pet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pet); i {
			case 0:
				return &v.state
			case 1:
		...
		file_moego_business_customer_v1_pet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
