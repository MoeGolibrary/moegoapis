...
func file_moego_business_customer_v1_customer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_moego_business_customer_v1_customer_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Customer_Note); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_moego_business_customer_v1_customer_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Customer_Tag); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
