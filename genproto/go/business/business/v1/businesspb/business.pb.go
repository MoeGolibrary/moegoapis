...
type Business struct {
	...
	// Original raw identifier for the business in product
	RawId int64 `protobuf:"varint,14,opt,name=raw_id,json=rawId,proto3" json:"raw_id,omitempty"`
...
func (x *Business) GetRawId() int64 {
	if x != nil {
		return x.RawId
	}
	return 0
...
const file_moego_business_business_v1_business_proto_rawDesc = "" +
	"\n" +
	")moego/business/business/v1/business.proto\x12\x1amoego.business.business.v1\x1a\x1dmoego/common/v1/address.proto\"\x83\x03\n" +
	"\bBusiness\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x15\n" +
	"\x06raw_id\x18\x0e \x01(\x03R\x05rawId\x12\x12\n" +
