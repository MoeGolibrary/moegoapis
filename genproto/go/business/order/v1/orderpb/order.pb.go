...
type Order struct {
	...
	// Original raw identifier for the order in product
	RawId int64 `protobuf:"varint,23,opt,name=raw_id,json=rawId,proto3" json:"raw_id,omitempty"`
...
type OrderRedeemPackage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unique identifier for the package service record
	// Format: "ps_" followed by random characters
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
...
func (x *OrderRedeemPackage) Reset() {
	*x = OrderRedeemPackage{}
	mi := &file_moego_business_order_v1_order_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OrderRedeemPackage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrderRedeemPackage) ProtoMessage() {}

func (x *OrderRedeemPackage) ProtoReflect() protoreflect.Message {
	mi := &file_moego_business_order_v1_order_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrderRedeemPackage.ProtoReflect.Descriptor instead.
func (*OrderRedeemPackage) Descriptor() ([]byte, []int) {
	return file_moego_business_order_v1_order_proto_rawDescGZIP(), []int{1}
}

func (x *OrderRedeemPackage) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *OrderRedeemPackage) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *OrderRedeemPackage) GetPackageId() string {
	if x != nil {
		return x.PackageId
	}
	return ""
...
func (x *OrderRedeemPackage) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *OrderRedeemPackage) GetServicePrice() *money.Money {
	if x != nil {
...
func (x *OrderRedeemPackage) GetPackageServiceId() string {
	if x != nil {
...
func (x *OrderRedeemPackage) GetPackageName() string {
	if x != nil {
...
func (x *OrderRedeemPackage) GetServiceName() string {
	if x != nil {
...
func (x *OrderRedeemPackage) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
const file_moego_business_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"#moego/business/order/v1/order.proto\x12\x17moego.business.order.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/type/money.proto\"\xd9\t\n" +
	"\x05Order\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x15\n" +
	"\x06raw_id\x18\x17 \x01(\x03R\x05rawId\x12\x1f\n" +
	...
	"\rservice_price\x18\x06 \x01(\v2\x12.google.type.MoneyR\fservicePrice\x12,\n" +
	"\x12package_service_id\x18\a \x01(\tR\x10packageServiceId\x12!\n" +
...
var file_moego_business_order_v1_order_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_moego_business_order_v1_order_proto_goTypes = []any{
	...
	(*OrderRedeemPackage)(nil),    // 2: moego.business.order.v1.OrderRedeemPackage
...
var file_moego_business_order_v1_order_proto_depIdxs = []int32{
	...
	3,  // 9: moego.business.order.v1.Order.remain_amount:type_name -> google.type.Money
	3,  // 10: moego.business.order.v1.Order.refunded_amount:type_name -> google.type.Money
