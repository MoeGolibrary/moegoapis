...
func (x *ListWebhookDeliveriesRequest_Filter) GetEventIds() []string {
	if x != nil {
		return x.EventIds
	}
	return nil
...
const file_moego_business_webhook_v1_webhook_service_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x02R\x02id\x12\"\n" +
	"\n" +
	"webhook_id\x18\x02 \x01(\tB\x03\xe0A\x02R\twebhookId\"\xc5\x03\n" +
	...
	"\x06filter\x18\x03 \x01(\v2>.moego.business.webhook.v1.ListWebhookDeliveriesRequest.FilterR\x06filter\x1a\xe6\x01\n" +
	"\x06Filter\x12I\n" +
	...
	"\rdelivery_time\x18\x03 \x01(\v2\x15.google.type.IntervalB\x03\xe0A\x01R\fdeliveryTime\x12 \n" +
	"\tevent_ids\x18\x04 \x03(\tB\x03\xe0A\x01R\beventIdsB\n" +
	"\n" +
	"\b_success\"\x93\x01\n" +
