...
type Appointment struct {
	...
	// When true, the appointment is considered deleted but still accessible via GET API
	// to maintain consistency with client expectations. This field allows clients to
	// identify deleted appointments and handle them appropriately.
	IsDeprecated  bool `protobuf:"varint,28,opt,name=is_deprecated,json=isDeprecated,proto3" json:"is_deprecated,omitempty"`
...
func (x *Appointment) GetIsDeprecated() bool {
	if x != nil {
...
const file_moego_business_appointment_v1_appointment_proto_rawDesc = "" +
	"\n" +
	"/moego/business/appointment/v1/appointment.proto\x12\x1dmoego.business.appointment.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1agoogle/type/interval.proto\x1a\x17google/type/money.proto\x1a6moego/business/appointment/v1/pet_service_detail.proto\x1a\x1dmoego/common/v1/address.proto\"\x8f\x0e\n" +
	...
	"\vno_show_fee\x18\x1b \x01(\v2\x12.google.type.MoneyR\tnoShowFee\x12#\n" +
	"\ris_deprecated\x18\x1c \x01(\bR\fisDeprecated\"w\n" +
	"\x06Status\x12\x16\n" +
