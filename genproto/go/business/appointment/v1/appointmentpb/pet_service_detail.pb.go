...
func file_moego_business_appointment_v1_pet_service_detail_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_moego_business_appointment_v1_pet_service_detail_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_moego_business_appointment_v1_pet_service_detail_proto_msgTypes[1].Exporter = func(v any, i int) any {
