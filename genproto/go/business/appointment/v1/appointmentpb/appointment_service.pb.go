...
func (x *PetService) GetServices() []*Service {
	if x != nil {
		return x.Services
	}
	return nil
...
type Service struct {
	...
	StaffIds  []string           `protobuf:"bytes,3,rep,name=staff_ids,json=staffIds,proto3" json:"staff_ids,omitempty"` // the service provider
}
...
func (x *Service) GetDuration() *interval.Interval {
	if x != nil {
		return x.Duration
	}
	return nil
...
func (x *Service) GetStaffIds() []string {
	if x != nil {
		return x.StaffIds
	}
	return nil
...
var file_moego_business_appointment_v1_appointment_service_proto_rawDesc = []byte{
	...
	0x52, 0x0b, 0x70, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x71, 0x0a,
	0x0a, 0x50, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x06, 0x70,
	0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02,
	0x52, 0x05, 0x70, 0x65, 0x74, 0x49, 0x64, 0x12, 0x47, 0x0a, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6d, 0x6f, 0x65, 0x67,
	...
	0x65, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x22, 0x7d, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x22, 0x0a, 0x0a, 0x73,
	...
	0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x73, 0x74, 0x61, 0x66, 0x66, 0x49, 0x64, 0x73, 0x22,
	0x42, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	...
	0x74, 0x49, 0x64, 0x32, 0xf5, 0x03, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d,
	...
	0x73, 0x3a, 0x6c, 0x69, 0x73, 0x74, 0x12, 0xa2, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x61, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0xa5, 0x01, 0x0a, 0x25,
...
var file_moego_business_appointment_v1_appointment_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_moego_business_appointment_v1_appointment_service_proto_goTypes = []any{
	...
	(*Service)(nil),                        // 5: moego.business.appointment.v1.Service
	(*CreateAppointmentResponse)(nil),      // 6: moego.business.appointment.v1.CreateAppointmentResponse
	(*ListAppointmentsRequest_Filter)(nil), // 7: moego.business.appointment.v1.ListAppointmentsRequest.Filter
	(*commonpb.Pagination)(nil),            // 8: moego.common.v1.Pagination
	(*Appointment)(nil),                    // 9: moego.business.appointment.v1.Appointment
...
var file_moego_business_appointment_v1_appointment_service_proto_depIdxs = []int32{
	8,  // 0: moego.business.appointment.v1.ListAppointmentsRequest.pagination:type_name -> moego.common.v1.Pagination
	7,  // 1: moego.business.appointment.v1.ListAppointmentsRequest.filter:type_name -> moego.business.appointment.v1.ListAppointmentsRequest.Filter
	9,  // 2: moego.business.appointment.v1.ListAppointmentsResponse.appointments:type_name -> moego.business.appointment.v1.Appointment
	...
	5,  // 4: moego.business.appointment.v1.PetService.services:type_name -> moego.business.appointment.v1.Service
	10, // 5: moego.business.appointment.v1.Service.duration:type_name -> google.type.Interval
	10, // 6: moego.business.appointment.v1.ListAppointmentsRequest.Filter.start_time:type_name -> google.type.Interval
	10, // 7: moego.business.appointment.v1.ListAppointmentsRequest.Filter.end_time:type_name -> google.type.Interval
	10, // 8: moego.business.appointment.v1.ListAppointmentsRequest.Filter.last_updated_time:type_name -> google.type.Interval
	11, // 9: moego.business.appointment.v1.ListAppointmentsRequest.Filter.statuses:type_name -> moego.business.appointment.v1.Appointment.Status
	...
	9,  // 13: moego.business.appointment.v1.AppointmentService.GetAppointment:output_type -> moego.business.appointment.v1.Appointment
	...
	6,  // 15: moego.business.appointment.v1.AppointmentService.CreateAppointment:output_type -> moego.business.appointment.v1.CreateAppointmentResponse
