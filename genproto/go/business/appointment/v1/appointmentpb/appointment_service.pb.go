...
type CreateAppointmentRequest struct {
	...
	// PetService info
	PetServices []*CreateAppointmentRequest_PetService `protobuf:"bytes,7,rep,name=pet_services,json=petServices,proto3" json:"pet_services,omitempty"`
}
...
var file_moego_business_appointment_v1_appointment_service_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x73, 0x74, 0x61, 0x66, 0x66, 0x49, 0x64, 0x73, 0x22, 0x42,
	...
	0x49, 0x64, 0x32, 0xf6, 0x03, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d, 0x65,
	...
	0x3a, 0x6c, 0x69, 0x73, 0x74, 0x12, 0xa3, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x41, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x37, 0x2e, 0x6d, 0x6f,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x38, 0x2e, 0x6d, 0x6f, 0x65, 0x67, 0x6f, 0x2e, 0x62, 0x75, 0x73,
	0x69, 0x6e, 0x65, 0x73, 0x73, 0x2e, 0x61, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d, 0x65, 0x6e,
	0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x70, 0x70, 0x6f, 0x69,
	0x6e, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1b,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x15, 0x3a, 0x01, 0x2a, 0x22, 0x10, 0x2f, 0x76, 0x31, 0x2f, 0x61,
	0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x42, 0xa5, 0x01, 0x0a, 0x25,
...
var file_moego_business_appointment_v1_appointment_service_proto_goTypes = []any{
	...
	(*CreateAppointmentResponse)(nil),           // 4: moego.business.appointment.v1.CreateAppointmentResponse
	(*ListAppointmentsRequest_Filter)(nil),      // 5: moego.business.appointment.v1.ListAppointmentsRequest.Filter
	(*CreateAppointmentRequest_PetService)(nil), // 6: moego.business.appointment.v1.CreateAppointmentRequest.PetService
	(*CreateAppointmentRequest_Service)(nil),    // 7: moego.business.appointment.v1.CreateAppointmentRequest.Service
...
var file_moego_business_appointment_v1_appointment_service_proto_depIdxs = []int32{
	...
	5,  // 1: moego.business.appointment.v1.ListAppointmentsRequest.filter:type_name -> moego.business.appointment.v1.ListAppointmentsRequest.Filter
	...
	6,  // 3: moego.business.appointment.v1.CreateAppointmentRequest.pet_services:type_name -> moego.business.appointment.v1.CreateAppointmentRequest.PetService
	10, // 4: moego.business.appointment.v1.ListAppointmentsRequest.Filter.start_time:type_name -> google.type.Interval
	10, // 5: moego.business.appointment.v1.ListAppointmentsRequest.Filter.end_time:type_name -> google.type.Interval
	10, // 6: moego.business.appointment.v1.ListAppointmentsRequest.Filter.last_updated_time:type_name -> google.type.Interval
	11, // 7: moego.business.appointment.v1.ListAppointmentsRequest.Filter.statuses:type_name -> moego.business.appointment.v1.Appointment.Status
	7,  // 8: moego.business.appointment.v1.CreateAppointmentRequest.PetService.services:type_name -> moego.business.appointment.v1.CreateAppointmentRequest.Service
	10, // 9: moego.business.appointment.v1.CreateAppointmentRequest.Service.duration:type_name -> google.type.Interval
	...
	4,  // 15: moego.business.appointment.v1.AppointmentService.CreateAppointment:output_type -> moego.business.appointment.v1.CreateAppointmentResponse
