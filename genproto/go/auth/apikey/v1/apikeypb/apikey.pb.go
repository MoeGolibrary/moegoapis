...
func file_moego_auth_apikey_v1_apikey_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_moego_auth_apikey_v1_apikey_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Key); i {
			case 0:
				return &v.state
			case 1:
		...
		file_moego_auth_apikey_v1_apikey_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_moego_auth_apikey_v1_apikey_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_moego_auth_apikey_v1_apikey_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*OrganizationRestrictions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_moego_auth_apikey_v1_apikey_proto_msgTypes[4].Exporter = func(v any, i int) any {
